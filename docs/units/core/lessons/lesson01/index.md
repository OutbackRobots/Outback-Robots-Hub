...
type: lesson
unit_id: core
lesson_id: 01_meetblossom
lesson_no: 01
lesson_title: Meet Blossom
year_level: [5, 6]
duration_min: 90
lesson_summary: In this lesson, students explore where robots are found in everyday life, what makes something a robot, and what parts Blossom and other robots need to work.
